...
| Local storage        | Room 2.8.5 (Android/Desktop), DataStore 1.2.1 (Android)                   |
| Testing              | JUnit 4.13.2, MockK 1.14.11, Coroutines Test 1.11.0                       |
| Concurrency          | Kotlin Coroutines 1.11.0                                                  |
| Networking           | Ktor 3.5.2 (client + server, online play at tarati.tech)                  |
| Redis client         | Kreds 0.9.1 (Kotlin-native, coroutines-first)                             |
| Database (server)    | PostgreSQL 16, Exposed ORM 1.5.0                                          |
| Auth (server)        | Auth0 java-jwt 4.6.1, jBCrypt 0.4                                         |
